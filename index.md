## [INNER I NET COMPANY](http://shapereality.innerinetcompany.hns.to/) | a first Handshake(HNS) blockchain root level domain buisness that is dismantling the monopoly in 2021 by Looking Within, to the Source. Handshake helps us resolve self sovereignty by allowing true ownership of authentic web space vs. renting a temporary identity on the internet. 
